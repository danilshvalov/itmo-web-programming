...
% TODO:
% что такое http и https и в чем их различия. - что такое uri, urn и url -
% tcp/ip и oci - также тэги html (таблицы, формы, текстовые) и css (ка
% киспользуется css, селекторы)
